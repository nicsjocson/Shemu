...
class Employee(models.Model):
    ...
    overtime_pay = models.FloatField(null=True, blank=True, default=0.0)
    allowance = models.FloatField(null=True, blank=True, default=0.0)

    def getName(self): return self.name
    def getID(self): return self.id_number
    def getRate(self): return self.rate
    def getOvertime(self): return self.overtime_pay or 0.0
    def resetOvertime(self):
        self.overtime_pay = 0.0
        self.save()
    def getAllowance(self): return self.allowance or 0.0
    
    def __str__(self):
        return f"pk: {self.id_number}, rate: {self.rate}"

class Payslip(models.Model):
    id_number = models.ForeignKey(Employee, on_delete=models.CASCADE, to_field="id_number")
